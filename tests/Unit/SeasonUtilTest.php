...
class SeasonUtilTest extends TestCase
{
    public function test_spring_date_return_correct_seasons()
    {
        ...
        $this->assertEquals('2021-07-31', $seasonDates['currentSeasonDates']['end']->format('Y-m-d'));
        $this->assertEquals('2020-08-01', $seasonDates['previousSeasonDates']['start']->format('Y-m-d'));
    ...
    public function test_fall_date_returns_correct_seasons()
    {
        ...
        $this->assertEquals('2021-08-01', $seasonDates['currentSeasonDates']['start']->format('Y-m-d'));
        ...
        $this->assertEquals('2021-07-31', $seasonDates['previousSeasonDates']['end']->format('Y-m-d'));
    }
}