                    ...
                    <x-panel header='Työkalut'>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-primary mt-1">
                                    <a style="color:white;" href="{{ route('notes.index') }}">Muokkaa
                                        tiedotteita</a></button>
                                <button type="button" class="btn btn-primary mt-1">
                                ...
                                <button type="button" class="btn btn-primary mt-1">
                                    <a style="color:white;" href="{{ route('index.update') }}">Päivitä</a></button>
                            </div>
                        </div>
                    </x-panel>
                </div>
                                ...
                                <tbody>
                                    @foreach ($users as $index => $user)
                                        <tr>
                                            ...
                                            <td><button data-id='{{ $user->id }}'
                                                    class="btn btn-primary btn-sm roleBtn">Muokkaa</button></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
