        ...
        <div class="col-md-12">
            <x-panel header="Muokkaa ryhmää">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <form id="groupForm" method="post" action="{{ route('update.group', $group->id) }}"
                            ...
                            <div class="form-group">
                                <div class="col-md-2">
                                    ...
                                    <button class="btn btn-danger ml-4" id="delete" type="button">Poista ryhmä</button>
                                </div>
                            </div>
